  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/80 backdrop-blur-sm animate-fadeIn">
      <div 
        ...
        className="relative w-full max-w-md bg-neutral-900 border-l border-neutral-800 text-white h-full flex flex-col shadow-2xl overflow-hidden"
      >
        {/* Drawer Header */}
              ...
              {cartItems.length === 0 ? (
                ...
                <div className="space-y-3">
                  {cartItems.map((item) => (
                    <div 
                      key={item.part.id}
                      className="p-3.5 rounded-xl bg-neutral-800/60 border border-neutral-700/80 flex gap-3 items-center"
                    >
                      <img 
                        src={item.part.image} 
                        alt={item.part.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <div className="flex items-center rounded-lg bg-neutral-900 border border-neutral-700 text-xs">
                            <button
                            ...
                            <span className="px-2 py-1 font-mono font-bold text-amber-400">
                              {item.quantity}
                            </span>
                            <button
                              onClick={() => onUpdateQuantity(item.part.id, item.quantity + 1)}
                          ...
                          <button 
                            ...
                            className="p-1 text-neutral-500 hover:text-red-400 transition ml-auto cursor-pointer"
                            title="Устгах"
                          >
            ...
            <form onSubmit={handleCheckoutSubmit} className="space-y-3.5 text-xs">
                ...
                <>
                  <div>
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-neutral-800 border border-neutral-700 text-white focus:border-amber-400 focus:outline-none"
                    />
                  </div>
                  <div>
                    <label className="block font-semibold text-neutral-300 mb-1">
                    ...
                    <input 
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-neutral-800 border border-neutral-700 text-white font-mono focus:border-amber-400 focus:outline-none"
                    />
                  </div>
                </>
              )}
              ...
              <div>
                ...
                <div className="space-y-1.5">
                  <label className="flex items-center gap-2 p-2 rounded-lg bg-neutral-800/80 border border-neutral-700 cursor-pointer">
                    <input 
                      type="radio" 
                      name="payment" 
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full py-2.5 px-4 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-amber-400/20"
                >
          ...
          {step === 'success' && (
            <div className="text-center py-10 space-y-4">
              ...
              <p className="text-xs text-neutral-300 leading-relaxed max-w-sm mx-auto">
                Таны захиалгыг манай сэлбэгийн менежер хүлээн авлаа. Таны <strong className="text-amber-400">{phone}</strong> дугаар луу нэхэмжлэх болон хүргэлтийн товч мэдээллийг 15 минутын дотор илгээх болно.
              </p>

              <div className="p-3.5 rounded-xl bg-neutral-800/80 border border-neutral-700 text-left text-xs space-y-1 text-neutral-300">
                <div className="flex justify-between">
                  <span className="text-neutral-400">Захиалгын дугаар:</span>
                  <span className="font-mono font-bold text-white">{orderNumber}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Төлбөрийн хэлбэр:</span>
                  <span className="text-amber-400 font-semibold">{paymentMethod.toUpperCase()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Нийт дүн (НӨАТ орсон):</span>
              ...
              <button
                ...
                className="w-full py-2.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-bold text-xs uppercase tracking-wider cursor-pointer"
              >
          ...
          <div className="p-4 sm:p-5 border-t border-neutral-800 bg-neutral-950 space-y-3">
            <div className="space-y-1.5 text-xs">
              ...
              <div className="flex justify-between text-sm font-bold text-white pt-1 border-t border-neutral-800">
                ...
                <span className="text-amber-400 font-mono text-base">{total.toLocaleString()} ₮</span>
              </div>
            </div>

            <button
              onClick={() => setStep('checkout')}
              className="w-full py-3 px-4 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-extrabold text-xs uppercase tracking-wider flex items-center justify-center gap-2 cursor-pointer shadow-lg shadow-amber-400/20"
            >
