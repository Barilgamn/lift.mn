...
export const PortalHome: React.FC<PortalHomeProps> = ({ 
  ...
  return (
    <div 
      id="portal-container"
      className="relative h-screen min-h-screen w-full flex flex-col justify-between overflow-x-hidden overflow-y-auto md:overflow-hidden bg-[#030B17] text-white select-none"
    >
      {/* Top Header Bar: Centered & Enlarged Delta Lifts Logo */}
      <header 
        id="portal-header" 
        className="relative z-30 w-full px-4 sm:px-8 py-3 sm:py-4 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 border-b border-sky-900/40 backdrop-blur-md bg-[#040D1E]/90 shrink-0 shadow-md shadow-black/40"
      >
        <div className="flex items-center gap-3 sm:gap-4">
          <DeltaLiftsLogo variant="official" size="lg" showText={true} textClassName="text-sky-300 group-hover:text-white" />
          <div className="hidden md:block h-7 w-px bg-sky-800/50" />
          <span className="hidden md:inline text-xs lg:text-sm font-bold tracking-widest text-sky-200/90 uppercase">
      ...
      <main 
        id="portal-tri-split"
        className="relative z-10 flex-1 w-full flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-sky-900/50"
      >
        {/* COLUMN 1: DELTA LIFT */}
        <section
        ...
        >
          ...
          {/* Top highlight bar */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-[#005C9E] group-hover:bg-[#38BDF8] group-hover:h-1.5 transition-all duration-300" />
          ...
          <div className="relative z-10 my-auto py-6 sm:py-8 flex flex-col items-center text-center">
            ...
            <p className="text-xs sm:text-sm font-semibold tracking-wider text-[#38BDF8] uppercase mb-4">
          ...
          <div className="relative z-10 w-full pt-4">
            <div className="w-full py-3 sm:py-3.5 px-4 rounded-xl bg-[#005C9E]/50 group-hover:bg-[#005C9E] text-white font-bold text-xs sm:text-sm uppercase tracking-wider flex items-center justify-center gap-2 transition-all duration-300 border border-sky-600/50 group-hover:border-sky-300 shadow-lg shadow-sky-950/50">
      ...
      <footer 
        id="portal-footer" 
        className="relative z-30 w-full px-4 sm:px-8 py-2.5 md:py-3 flex flex-wrap items-center justify-between gap-3 border-t border-sky-900/40 backdrop-blur-md bg-[#020814]/95 text-[11px] md:text-xs text-sky-300/70 shrink-0"
      >
        <div className="flex items-center gap-2">
          <span>© 2026 <strong className="text-white">DELTA LIFTS</strong> · <strong className="text-sky-300">LIFT.MN</strong>. Бүх эрх хуулиар хамгаалагдсан.</span>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-5">
          ...
          <a 
            ...
            className="flex items-center gap-1.5 text-sky-200/90 hover:text-white transition"
          >
            <PhoneCall className="w-3.5 h-3.5 text-sky-400" />
            <span className="font-mono font-semibold">(+976) 7723-2222</span>
          </a>

          <span className="hidden xl:inline text-sky-400/30">·</span>

          <span className="hidden md:flex items-center gap-1.5 text-sky-200/80">
          ...
          <span className="hidden lg:flex items-center gap-1.5 text-sky-300/80">
